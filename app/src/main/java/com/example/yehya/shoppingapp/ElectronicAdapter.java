...
public class ElectronicAdapter extends RecyclerView.Adapter<CompontViewHolder> {

    ArrayList<componts> compont ;
    final int itemLayoutId ;
    final ShoppingApp mainActivity ;

    public ElectronicAdapter(ShoppingApp mainActivity, ArrayList<componts>  componts, int itemLayoutId ){
    ...
    public void onBindViewHolder(@NonNull CompontViewHolder myViewHolder, int i) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mainActivity ,ElectronicNavigationDrwer.class);
